...
@Component({
    ...
    standalone: true,
    imports: [MenubarModule, PrimeTemplate, InputTextModule, BreadcrumbModule, TabMenuModule, StepsModule, RouterOutlet, TieredMenuModule, MenuModule, ContextMenuModule, MegaMenuModule, PanelMenuModule]
})
